...
public class PDFGenerator {
    ...
    // This method summarizes ingredients by category and product


    // This method generates a PDF with the summarized ingredients using Aspose.PDF
    public static void GeneratePDF(HashMap<String, HashMap<String, Integer>> categoryProductMap, String pdfFilePath) throws Exception {
